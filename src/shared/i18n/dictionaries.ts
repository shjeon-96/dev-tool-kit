...
const en: Dictionary = {
  ...
  home: {
    eyebrow: "PIXELLOGIC / LOCAL BY DEFAULT",
    title: "Small work,",
    titleAccent: "done lightly.",
    intro:
    ...
    proofOne: "Browser processing",
    proofTwo: "No account",
    proofThree: "0 bytes uploaded",
    toolsEyebrow: "FREQUENTLY USED",
    toolsTitle: "Pick a task. Keep moving.",
    toolsIntro:
      "Each utility is built around one repeatable task, with practical examples and clear output.",
    principleEyebrow: "BRAND PRINCIPLES",
    principleTitle: "Useful, warm, and clear.",
    principles: [
      {
...
const ko: Dictionary = {
  ...
  home: {
    ...
    primaryCta: "도구 둘러보기",
    secondaryCta: "왜 로컬 처리인가요?",
    proofOne: "브라우저에서 처리",
    proofTwo: "가입 없음",
    proofThree: "업로드 0바이트",
    toolsEyebrow: "자주 쓰는 작업",
    toolsTitle: "작업을 고르고 계속 나아가요.",
    toolsIntro:
      "반복되는 한 가지 작업에 집중하고, 실용적인 예시와 명확한 결과를 제공합니다.",
    principleEyebrow: "BRAND PRINCIPLES",
    principleTitle: "유용하고, 따뜻하고, 분명하게.",
    principles: [
      {
        title: "로컬 우선",
...
const ja: Dictionary = {
  ...
  home: {
    ...
    primaryCta: "ツールを見る",
    secondaryCta: "ローカル処理について",
    proofOne: "ブラウザ内で処理",
    proofTwo: "アカウント不要",
    proofThree: "アップロード0バイト",
    toolsEyebrow: "よく使う作業",
    toolsTitle: "作業を選び、そのまま進む。",
    toolsIntro:
      "各ツールは一つの反復作業に集中し、実例と明確な結果を提供します。",
    principleEyebrow: "BRAND PRINCIPLES",
    principleTitle: "役に立ち、温かく、明確に。",
    principles: [
      {
        title: "ローカル優先",
