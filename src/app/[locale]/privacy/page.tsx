...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      locale === "ko"
        ? "Web Toolkit의 개인정보 처리방침 및 데이터 보안 정책입니다."
        : "Privacy policy and data security policy for Web Toolkit.",
  };
}
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="text-muted-foreground">Last updated: December 06, 2025</p>

        <p>
          <strong>Web Toolkit</strong> (&quot;the Service&quot;) takes your
          privacy very seriously. This Privacy Policy explains how your
          information is managed when you use our Service.
        </p>

        <h2 className="text-xl font-semibold mt-8">
          1. Data Processing (Client-side Only)
        </h2>
        <p>
          The core tools of this Service (JSON Formatter, JWT Decoder, Image
          Resizer, etc.) operate{" "}
          <strong>entirely within your browser (client-side)</strong>.
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Any text, code, or image files you input are{" "}
            <strong>never transmitted to or stored on our servers</strong>.
          </li>
          <li>
            All computations happen immediately in your device&apos;s memory,
            and data is erased when you refresh the page.
          </li>
        </ul>
        ...
        <p>
          This Service displays advertisements through{" "}
          <strong>Google AdSense</strong> to cover operating costs.
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Google and third-party vendors may use cookies to serve ads based on
            your visits to this and other websites.
          </li>
          <li>
            Google uses advertising cookies to provide relevant ads to you.
          </li>
          <li>
        ...
        <h2 className="text-xl font-semibold mt-8">3. Log Data</h2>
        <p>
          Like most websites, our hosting server (Vercel) may automatically
          collect information that your browser sends when visiting the Service.
          This may include your IP address, browser type and version, visit
          time, and referring pages. This data is used solely to ensure service
          stability and troubleshoot technical issues.
        </p>

        <h2 className="text-xl font-semibold mt-8">4. External Links</h2>
        <p>
          This Service may contain links to external websites. The privacy
          policies of those external sites are not related to this Service, so
          please review their policies when visiting.
        </p>
