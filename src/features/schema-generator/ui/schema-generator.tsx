...
function ArticleForm({ data, updateField }: FormProps<ArticleSchema>) {
  return (
...
function ProductForm({ data, updateField }: FormProps<ProductSchema>) {
  return (
    <div className="space-y-4">
...
function FAQForm({ data, addItem, removeItem, updateItem }: FAQFormProps) {
  return (
    <div className="space-y-4">
...
function EventForm({ data, updateField }: FormProps<EventSchema>) {
  return (
    <div className="space-y-4">
