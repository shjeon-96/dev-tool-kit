...
| 영역                             | 규칙                    | 동작                                                                        |
| -------------------------------- | ----------------------- | --------------------------------------------------------------------------- |
| 제품 카드 (`.sola-product-grid`) | `auto-fill`, 최소 300px | 1120px에서 3열, 태블릿 2열, 모바일 1열. 카드 폭은 개수와 무관하게 일정하다. |
| 원칙 (`.sola-principle-grid`)    | `auto-fit`, 최소 240px  | 3개면 3열로 꽉 찬다. 늘어나면 줄바꿈한다.                                   |
| 히어로 앱 줄 (`.sola-hero-apps`) | `flex-wrap`             | 5개에서 3+2로 줄바꿈한다.                                                   |
